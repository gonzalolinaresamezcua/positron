...
final class Config
{
    ...
    public static function boot(): void
    {
        self::$items = [
            ...
            'openai.base' => rtrim((string) Env::get('OPENAI_API_BASE', 'https://api.openai.com'), '/'),
            'openai.model' => Env::get('OPENAI_MODEL', 'gpt-6-astra'),
            'openai.path' => Env::get('OPENAI_CHAT_PATH', '/v1/chat/completions'),
