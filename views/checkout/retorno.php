<section class="pg-card">
    ...
    <p>Mollie avisará a POSITROM por webhook. Si el cobro es correcto, tu órbita quedará activa (o pendiente de activación si así lo ha configurado administración).</p>
